    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        ...
        >
          ...
          <div className="mt-8 mb-24 flex flex-wrap justify-center gap-4">
            <Link
              to="/dashboard"
              className="px-8 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-full 
                       font-semibold hover:from-green-700 hover:to-blue-700 transition-all duration-300 
            ...
            <button
              ...
              className="px-8 py-3 bg-white/90 backdrop-blur-sm text-gray-800 rounded-full 
